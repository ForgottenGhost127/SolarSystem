...
public class SolarSystem : MonoBehaviour
{
   ...
   public Transform cameraM;
    ...
    void Start()
    {
        ...
        Sat3Trans.position = new Vector3(SunTrans.position.x + 9, SunTrans.position.y + 9, SunTrans.position.z + 9);
    ...
    void Update()
    {
        ...
        //Sat3
        Sat3Trans.RotateAround(SunTrans.position, Vector3.up, -60f * Time.deltaTime);
        ...
        Debug.DrawLine(SunTrans.position, Sat3Trans.position, Color.cyan);
        ...
        {
            Sat2Trans.localScale = Vector3.Lerp(Sat2Trans.localScale, new Vector3(3f, 3f, 3f), Time.deltaTime);
        }
    }
}
